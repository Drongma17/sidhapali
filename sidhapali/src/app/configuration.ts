...
export const configuration = {
    header: {
        heading: 'Trulshik Rinpoche',
        headingtext: 'Kyabjé Trulshik Rinpoche, Ngawang Chökyi Lodrö, was the reincarnation of Zhadeu Trulshik of Dzarong, and an emanation of Vajrapāni and Mañjuśrī. Since the time of our Lord Buddha, to benefit beings throughout India, Nepal and Tibet, he has manifested a succession of rebirths, including the Buddha’s disciple Ānanda; the great Indian master Āryadeva; Thönmi Sambhota, one of King Songtsen Gampo’s ministers and author of the first texts on Tibetan grammar, the Thirty Verses (sum cu pa) and Application of Signs (rtags kyi ’jug pa); the great Abbott Śāntarakshita, the great translator Vairotsana; in Nepal, Phamthingpa Vāgīśvarakīrti (Ngawang Trakpa); Milarepa’s close disciple Rechungpa; the master Melong Dorje; the all-knowing Longchenpa; the great siddha Lékyi Dorje of Lhodrak; and Zhadeu Trulshik Kunga Rinchen. These are just a few among Kyabje Trulshik Rinpoche’s previous lives, more of whom are mentioned in the prayer to his successive rebirths—but in truth, the full scope of an enlightened being’s activities is unfathomable even to great bodhisattvas, let alone to ordinary people like us.',
        buttontext: 'KYABJE TRULSHIK RINPOCHE (1924-2011)',
        buttonlink: '\home'
    },
    intro: {
        tagline: 'SUCESS',
    ...
    footer: {
        ...
        developer: 'Tibetan rocks',
        developerlink: 'http://thonglam.com',
    },
    socialsites: [
        {title: 'Facebook', target: '_blank', username: 'jagmohan', icon: 'facebook', link:'https://facebook.com'},
        {title: 'Google+', target: '_blank', username: '+jagmohan', icon: 'google-plus', link:'https://google.com'},
        {title: 'Twitter', target: '_blank', username: 'jagmohan', icon: 'twitter', link:'https://twitter.com'},
        {title: 'Instagram', target: '_blank', username: 'jagmohan', icon: 'instagram', link:'https://instagram.com'},
